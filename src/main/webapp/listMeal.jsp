...
<table>
    ...
    <c:forEach items="${requestScope.mealsList}" var="meals">
        ...
        <tr style="color:<%= textColor %>">
            ...
            <h4>
                <td><a href="listMeal?action=edit&mealId=<c:out value="${meals.mealId}"/>">Update</a></td>
            </h4>
            <h4>
                <td><a href="listMeal?action=delete&mealId=<c:out value="${meals.mealId}"/>">Delete</a></td>
            </h4>
        </tr>
    </c:forEach>
</table>
