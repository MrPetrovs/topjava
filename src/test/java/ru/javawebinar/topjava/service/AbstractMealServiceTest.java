...
public abstract class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    void create() {
        ...
        MATCHER_FOR_MEAL.assertMatch(service.get(newId, USER_ID), newMeal);
    }
    ...
    void get() {
        ...
        MATCHER_FOR_MEAL.assertMatch(actual, adminMeal1);
    }
    ...
    void update() {
        ...
        MATCHER_FOR_MEAL.assertMatch(service.get(MEAL1_ID, USER_ID), getUpdated());
    }
    ...
    void updateNotOwn() {
        ...
        MATCHER_FOR_MEAL.assertMatch(service.get(MEAL1_ID, USER_ID), meal1);
    }

    @Test
    void getAll() {
        MATCHER_FOR_MEAL.assertMatch(service.getAll(USER_ID), meals);
    }

    @Test
    void getBetweenInclusive() {
        MATCHER_FOR_MEAL.assertMatch(service.getBetweenInclusive(
    ...
    void getBetweenWithNullDates() {
        MATCHER_FOR_MEAL.assertMatch(service.getBetweenInclusive(null, null, USER_ID), meals);
    }
