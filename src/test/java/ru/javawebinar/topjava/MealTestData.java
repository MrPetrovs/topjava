...
public class MealTestData {
    public static final MatcherFactory<Meal> MATCHER_FOR_MEAL = MatcherFactory.usingIgnoringFieldsComparator(Meal.class, "user");
    public static final MatcherFactory<MealTo> MATCHER_FOR_MEALTO = MatcherFactory.usingIgnoringFieldsComparator(MealTo.class);
